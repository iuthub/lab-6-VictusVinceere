...
$isFormError = $isNameError || $isEmailError || $isUsernameError || $isPasswordError || $isConfpasswordError || $isDateofbError || $isGenderError || $isMaritalError|| $isAddressError || $isCityError || $isPostalCodeError || $isHomePhoneError || $isMobilePhoneError || $isCreditCardNumberError || $isCreditExpError|| $isMSalaryError || $isUrlError || $isGpaError; 
